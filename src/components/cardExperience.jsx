...
const CardsExperience = () => {
  ...
  return (
    <div
      className={`cardsExperienceContainer ${containerExpanded ? "expanded" : ""
        }`}
    >
      <div
        className={`cardsExperience ${expandedCard === 1 ? "expanded" : ""}`}
      ...
      <div
        className={`cardsExperience ${expandedCard === 2 ? "expanded" : ""}`}
            ...
            <div className="experienceContainer">
              <div>
                ...
                <p>
                  ...
                  Node.JS, Business intelligence, Méthode agile, Administration
                  OS Serveur
                </p>
              </div>
              <div>
      ...
      <div
        className={`cardsExperience ${expandedCard === 3 ? "expanded" : ""}`}
